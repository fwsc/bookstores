...
export class AppGlobal {
    ...
    //接口基地址
    static domain = "http://39.108.74.119"

    //接口地址
    static API: any = {
        getUser:'/fwsc_api/getuserinfo',
        login: '/fwsc_api/login',
        getBooks:'/fwsc_api/getbooks',
        register: '/fwsc_api/register',
        getaddress: '/fwsc_api/getaddress',
        addorder: '/fwsc_api/addorder',
        getmyorder: '/fwsc_api/getmyorder',
        setgouwuche: '/fwsc_api/setgouwuche',
        getgouwuche: '/fwsc_api/getgouwuche',
        getalladdress: '/fwsc_api/getalladdress',
        search:'/fwsc_api/seach',
